...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('public/assets/css/fontawesome-all.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('public/assets/css/swiper.css')); ?>" rel="stylesheet" />
    ...
    <!-- Favicon  -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('public/assets/images/apple-touch-icon.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('public/assets/images/favicon-32x32.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('public/assets/images/favicon-16x16.png')); ?>">
       <link rel="icon" href="<?php echo e(asset('public/assets/images/favicon.png')); ?>" />

    <link rel="manifest" href="<?php echo e(asset('public/assets/images/site.webmanifest')); ?> ">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand logo-image" href="index.html"
          ><img src="<?php echo e(asset('public/assets/images/logo.png')); ?>" alt="alternative"
        /></a>
            ...
            <div class="col-lg-6 col-xl-7">
              <div class="image-container">
                <div class="img-wrapper">
                  <img
                    class="img-fluid"
                    src="<?php echo e(asset('public/assets/images/header-software-app.png')); ?>"
                    alt="alternative"
                  />
                </div>
                <!-- end of img-wrapper -->
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-image">
                <img
                  class="img-fluid"
                  src="<?php echo e(asset('public/assets/images/description-1.png')); ?>"
                  alt="alternative"
                />
              </div>
              <div class="card-body">
            ...
            <div class="card">
              <div class="card-image">
                <img
                  class="img-fluid"
                  src="<?php echo e(asset('public/assets/images/description-2.png')); ?>"
                  alt="alternative"
                />
              </div>
              <div class="card-body">
            ...
            <div class="card">
              <div class="card-image">
                <img
                  class="img-fluid"
                  src="<?php echo e(asset('public/assets/images/description-3.png')); ?>"
                  alt="alternative"
                />
              </div>
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="image-container">
                      <img
                        class="img-fluid"
                        src="<?php echo e(asset('public/assets/images/features-1.png')); ?>"
                        alt="alternative"
                      />
                    </div>
                    <!-- end of image-container -->
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="image-container">
                      <img
                        class="img-fluid"
                        src="<?php echo e(asset('public/assets/images/features-2.png')); ?>"
                        alt="alternative"
                      />
                    </div>
                    <!-- end of image-container -->
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="image-container">
                      <img
                        class="img-fluid"
                        src="<?php echo e(asset('public/assets/images/features-3.png')); ?>"
                        alt="alternative"
                      />
                    </div>
                    <!-- end of image-container -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="image-container">
              <img
                class="img-fluid"
                src="<?php echo e(asset('public/assets/images/details-lightbox.png')); ?>"
                alt="alternative"
              />
            </div>
            <!-- end of image-container -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="image-container">
              <img
                class="img-fluid"
                src="<?php echo e(asset('public/assets/images/details.png')); ?>"
                alt="alternative"
              />
            </div>
            <!-- end of image-container -->
  ...
  <img class="mt-3 mx-3 downloadImg" src="<?php echo e(asset('public/assets/images/windows-22.png')); ?>" alt="">
  <img class="mt-3 mx-3 downloadImg" src="<?php echo e(asset('public/assets/images/andriod.png')); ?>" alt="">
  <img class="mt-3 mx-3 downloadImg" src="<?php echo e(asset('public/assets/images/IOS.png')); ?>" alt="">
    ...
    <!-- Bootstrap framework -->
    <script src="<?php echo e(asset('public/assets/js/jquery.easing.min.js')); ?>"></script>
    <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo e(asset('public/assets/js/swiper.min.js')); ?>"></script>
    <!-- Swiper for image and text sliders -->
    <script src="<?php echo e(asset('public/assets/js/jquery.magnific-popup.js')); ?>"></script>
    <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo e(asset('public/assets/js/validator.min.js')); ?>"></script>
