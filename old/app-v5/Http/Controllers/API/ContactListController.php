...
class ContactListController extends Controller
{
    ...
    public function index()
    {
        ...
        $contactList = ContactList::with(['contactOffices','Offices'])->where('office_id', $office_id)
    ...
    public function messages(int $id)
    {
        ...
        if ($contactList) {
            return response()->json(['success' => 'messages retrived succefull', 'data' => $contactList], 200);
        } else {
            return response()->json(['failed' => 'Contacts Not Found ',], 404);
        }
    }
