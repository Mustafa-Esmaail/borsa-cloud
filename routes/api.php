...
Route::post('/forget-password', [AuthController::class, 'sendResetLinkEmail'])->name('forget-password');
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::delete('/offices', [OfficeController::class, 'destroy'])->name('office.destroy');
    Route::post('/offices/search', [OfficeController::class, 'search'])->name('contact.search');

    Route::post('/create-office', [OfficeController::class, 'ApiCreate'])->name('office.create');
    Route::get('/notifications', [OfficeController::class, 'notification'])->name('office.notification');
    Route::get('/notifications/set-read/{id}', [OfficeController::class, 'SetReadnotification'])->name('office.SetReadnotification');
    ...
    Route::group(['prefix' => 'transaction'], function () {
        ...
        Route::get('/office-summry/{id}', [TransactionController::class, 'officeSummry']);

        Route::get('/manual-office/{id}', [TransactionController::class, 'Manualoffice']);
    ...
    Route::group(['prefix' => 'contact-list'], function () {
        ...
        Route::post('/send-message', [ContactListController::class, 'sendMessage'])->name('contact.sendMessage');
        Route::get('/message/{id}', [ContactListController::class, 'messages'])->name('contact.messages');
        Route::post('/search', [ContactListController::class, 'search'])->name('contact-list.search');
    });
